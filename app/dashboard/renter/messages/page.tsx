...
import { Bell, Calendar, CreditCard, Home, MessageSquare, Settings, User, ShoppingBag } from "lucide-react"
        ...
        <main className="flex-1 overflow-auto">
          <div className="container py-6">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Communicate with borrowers</p>
            </div>
