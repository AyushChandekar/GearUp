...
export default function RenterSettingsPage() {
  ...
  async function fetchUserData(userId: string) {
    try {
      ...
      setSettings({
        ...
        auto_approve_bookings: data.auto_approve_bookings ?? false,
  ...
  async function saveRentalSettings() {
    try {
      ...
      toast({
        title: "Settings Saved",
        description: "Your rental preferences have been updated.",
      })
    } catch (error) {
      console.error("Error saving settings:", error)
      toast({
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="notifications" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="rental">Rental Preferences</TabsTrigger>
        ...
        <TabsContent value="rental" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage how your items are rented.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between space-x-2">
                <Label htmlFor="auto_approve_bookings" className="flex-1">
                  Auto-Approve Bookings
                  <p className="text-sm font-normal text-muted-foreground">
                    Automatically approve booking requests for your items.
                  </p>
                </Label>
                <Switch
                  id="auto_approve_bookings"
                  checked={settings.auto_approve_bookings}
                  onCheckedChange={(checked) => setSettings({ ...settings, auto_approve_bookings: checked })}
                />
              </div>
              <div className="flex items-center justify-between space-x-2">
                <Label htmlFor="instant_booking" className="flex-1">
                  Instant Booking
                  <p className="text-sm font-normal text-muted-foreground">
                    Allow borrowers to instantly book your items without approval.
                  </p>
                </Label>
                <Switch
                  id="instant_booking"
            ...
            <CardFooter>
              <Button onClick={saveRentalSettings} disabled={saving}>
                {saving ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                Save Changes
              </Button>
            </CardFooter>
